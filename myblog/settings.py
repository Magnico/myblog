...
SECRET_KEY = 'django-insecure-vuwz-x0*jtl)mg--hz!2sqk31*(rn$no*!%cs@dqziiywv9(3d'
...
MIDDLEWARE = [
    ...
    'blog.middleware.RedisMiddleware',
...
REDIS_HOST = '127.0.0.1'  # Replace with your Redis server host
